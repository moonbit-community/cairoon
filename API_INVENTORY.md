...
| Scaled fonts | Partial | External object, constructor, matrices/options/font-face getters, sheared font/CTM scale-matrix combination coverage, font/text/glyph extents and empty, single/multi/spaced ASCII, and UTF-8 text-to-glyph string/coordinate cases with direct C Cairo oracle coverage, executable Font reference docs for matrices/options/metrics/text-to-glyphs/errors, and Context get/set |
