...
| Publication integrity | The zip contains the declared dual-license notice and full texts, native-only module metadata, package README/interface, dependency pre-build script, complete source-identical pycairo API audit toolchain, and source-identical external-owner checker/ledger; canonical paths are unique, safe, CRC-valid, and exclude integration fixtures | Done locally: `scripts/check-publication-archive.py` checks all 642 members, and fourteen focused tests cover valid archives plus missing/incorrect license data, metadata/target mismatch, missing or altered build/API/owner support, duplicate names, unsafe paths, fixture leakage, emptiness, and corruption |
...
Exact Linux Cairo 1.15.10 and 1.18.4 each pass 840/840 native tests, 191/191
...
archive integrity for 642 members, and every discovered package under
