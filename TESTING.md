...
| Publication integrity | The zip contains the declared dual-license notice and full texts, module metadata, package README/interface, dependency pre-build script, and pinned pycairo API snapshot; canonical paths are unique, safe, CRC-valid, and exclude integration fixtures | Done locally: `scripts/check-publication-archive.py` checks all 629 members, and eleven focused tests cover valid archives plus missing/incorrect license data, metadata mismatch, missing build/API support, duplicate names, unsafe paths, fixture leakage, emptiness, and corruption |
...
Exact Linux Cairo 1.15.10 and 1.18.4 each pass 826/826 native tests, 161/161
...
archive integrity for 629 members, and every discovered package under
