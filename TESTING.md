...
`src/tests/context`, and `src/tests/pattern`, targeted white-box image,
ScaledFont, vector-output, surface stream, script-device, object-trait,
context-lifetime, path, and raster-pattern tests, the full
