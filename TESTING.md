...
destination/document-structure, mixed vector/tag/text, layered three-page, and wide three-page
...
stream-vs-file two-page, tagged three-page, mixed vector/tag/text, layered
