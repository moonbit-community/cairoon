...
| Behavioral parity | pycairo-derived black-box cases or direct C Cairo primitive oracles cover normal and invalid inputs | Strong for image, context, path, font, pattern, region, surface/device, and backend helpers already listed in the inventory; all 236 upstream Context, Device, Font, Matrix, Pattern, Region, and Surface tests are pinned and mapped to 151 family-local MoonBit runtime anchors, 196 required generated static API anchors, and 16 deliberately absent signatures |
...
other strict environments. The current Context, Device, Font, Matrix, Pattern,
Region, and Surface ledgers cover 236 upstream tests with 151 family-local
runtime anchors, 196 required public signatures, and 16 deliberately absent
