...
`matrix.mbt.md` for pure-value affine transforms and `region.mbt.md` for Region
construction, rectangle queries, boolean operations, and checked error mapping.
