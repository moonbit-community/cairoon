...
class CurrentReleaseEvidenceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.current_stability_evidence = (
            ...
            f"pass {self.script_test_marker}, 828/828 native tests, 63/63 executable "
            "docs, source and extracted consumers plus the unmodified cross-host "
            "archive consumer, all 626 publication members, and every package under "
        ...
        self.tests_evidence = (
            ...
            f"Cairo 1.18.4 lanes pass {self.script_test_marker}, 828/828 native tests, "
            ...
            "unmodified cross-host archive consumer, all 626 publication members, "
    ...
    def test_tests_evidence_requires_exact_native_count(self) -> None:
        notes = self.tests_evidence.replace("828/828 native tests", "native tests")
        errors = self.check_inventory(notes)
        self.assertTrue(any("828/828 native tests" in error for error in errors))
