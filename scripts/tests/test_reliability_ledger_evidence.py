...
class CurrentReleaseEvidenceTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.current_stability_evidence = (
            ...
            f"executable docs, {self.owner_evidence_marker}, source and extracted "
        ...
        self.tests_evidence = (
            ...
            "FFI boundary, source and extracted consumers plus the unmodified "
            f"cross-host archive consumer, all {self.publication_marker}, "
