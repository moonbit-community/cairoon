"""Pycairo ordinary-method-to-cairoon evidence mappings."""
...
# Portable pycairo methods that must have public cairoon API equivalents.
# Python protocols are audited separately; the four platform-native XCB/Xlib
# methods are accounted for below by explicit product Decisions.
...
X11_EXTENSION_DECISION = (
    "requires a future conditional extension layer with X11/XCB headers",
)


METHOD_DECISION_ANCHORS: dict[str, dict[str, tuple[str, ...]]] = {
    "XCBSurface": {
        "set_size": X11_EXTENSION_DECISION,
    },
    "XlibSurface": {
        "get_depth": X11_EXTENSION_DECISION,
        "get_height": X11_EXTENSION_DECISION,
        "get_width": X11_EXTENSION_DECISION,
    },
}
