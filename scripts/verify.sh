...
run moon test context_path_test.mbt --target native -v
run moon test path_test.mbt --target native -v
run moon test context_group_test.mbt --target native -v
run moon test context_text_test.mbt --target native -v
run moon test glyph_array_test.mbt --target native -v
run moon test context_extents_test.mbt --target native -v
run moon test context_clip_test.mbt --target native -v
run moon test context_painting_test.mbt --target native -v
...
run moon test region_test.mbt --target native -v
...
if [[ "$asan_mode" != "0" ]]; then
  ...
  if [[ -n "$clang_path" && -x "$clang_path" ]]; then
    ...
    run env \
      ...
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
      moon test context_path_test.mbt --target native -v
    run env \
      "MOON_CC=$clang_path" \
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
      moon test path_test.mbt --target native -v
    run env \
      "MOON_CC=$clang_path" \
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
      moon test context_group_test.mbt --target native -v
    run env \
      "MOON_CC=$clang_path" \
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
      moon test context_text_test.mbt --target native -v
    run env \
      "MOON_CC=$clang_path" \
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
      moon test glyph_array_test.mbt --target native -v
    run env \
      "MOON_CC=$clang_path" \
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
    ...
    run env \
      ...
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
      moon test context_painting_test.mbt --target native -v
    run env \
      "MOON_CC=$clang_path" \
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
    ...
    run env \
      ...
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
      moon test region_test.mbt --target native -v
    run env \
      "MOON_CC=$clang_path" \
      "MOON_AR=$moon_ar" \
      "ASAN_OPTIONS=$asan_options" \
