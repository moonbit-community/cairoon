...
type checking, pinned pycairo Context and Pattern test parity, full MoonBit
tests, executable docs, direct C Cairo oracle tests, `moon info`, and targeted
ASan runs when an ASan-capable compiler is available.
