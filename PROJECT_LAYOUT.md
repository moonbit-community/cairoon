...
- 68 `.mbt` implementation files directly in `src/`.
...
- 131 `*_test.mbt` files under `src/tests/`, including black-box and oracle
  packages.
...
- 47 oracle C implementation files in `src/tests/oracle/native/`.
