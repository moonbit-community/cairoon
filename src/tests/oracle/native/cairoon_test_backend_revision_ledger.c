  ...
  switch (kind) {
    case CAIROON_TEST_VECTOR_PDF:
      ...
      cairo_pdf_surface_set_metadata(
        ...
        "2026-01-02T03:04:05+00:00");
      cairo_pdf_surface_set_custom_metadata(surface, "RevisionLedger", "draft");
      cairo_pdf_surface_set_custom_metadata(surface, "RevisionLedger", "final");
      cairo_pdf_surface_set_custom_metadata(surface, "Stage", "proposal");
      cairo_pdf_surface_set_custom_metadata(surface, "Stage", "accepted");
      cairo_pdf_surface_set_custom_metadata(surface, "Ephemeral", "remove-me");
      cairo_pdf_surface_set_custom_metadata(surface, "Ephemeral", NULL);
