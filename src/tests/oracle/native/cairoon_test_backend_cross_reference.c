  ...
  switch (kind) {
    case CAIROON_TEST_VECTOR_PDF:
      ...
      cairo_pdf_surface_set_metadata(
        ...
        "2026-01-02T03:04:05+00:00");
      cairoon_test_pdf_surface_set_custom_metadata(surface, "CrossRef", "draft");
      cairoon_test_pdf_surface_set_custom_metadata(surface, "CrossRef", "final");
      cairoon_test_pdf_surface_set_custom_metadata(surface, "StaleCrossRef", "drop-me");
      cairoon_test_pdf_surface_set_custom_metadata(surface, "StaleCrossRef", NULL);
