...
enum {
  ...
  CAIROON_TEST_IMAGE_MESH_SURFACE_SOFT_LIGHT_COMBO = 40,
  CAIROON_TEST_IMAGE_DIFFERENCE_SURFACE_STROKE_COMBO = 41,
  ...
  switch (scene) {
    ...
    case CAIROON_TEST_IMAGE_GRADIENT_SURFACE_OVERLAY_COMBO:
      return cairoon_test_apply_gradient_surface_overlay_combo(
        ...
        width,
        height);
    case CAIROON_TEST_IMAGE_MESH_SURFACE_SOFT_LIGHT_COMBO:
      return cairoon_test_apply_mesh_surface_soft_light_combo(
        cr,
        width,
        height);
    case CAIROON_TEST_IMAGE_DIFFERENCE_SURFACE_STROKE_COMBO:
      return cairoon_test_apply_difference_surface_stroke_combo(
        cr,
        width,
        height);
    case CAIROON_TEST_IMAGE_RADIAL_COLOR_DODGE_SURFACE_COMBO:
      return cairoon_test_apply_radial_color_dodge_surface_combo(
        cr,
        width,
        height);
    case CAIROON_TEST_IMAGE_LINEAR_HSL_HUE_SURFACE_MASK_COMBO:
      return cairoon_test_apply_linear_hsl_hue_surface_mask_combo(
        cr,
        width,
        height);
    case CAIROON_TEST_IMAGE_LINEAR_HSL_SATURATION_SURFACE_GROUP_COMBO:
      return cairoon_test_apply_linear_hsl_saturation_surface_group_combo(
        cr,
        width,
        height);
